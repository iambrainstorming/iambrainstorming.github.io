...
Students can complete weekly or monthly formative assessments, practice exercises, and submit evidence of their learning through decentralized applications built on [Nostr](https://iambrainstorming.github.io/coding_blog/nostr/nostr_tutorial/introduction.html). Learning evidence may include written work, projects, presentations, peer reviews, community service, or skill demonstrations.
