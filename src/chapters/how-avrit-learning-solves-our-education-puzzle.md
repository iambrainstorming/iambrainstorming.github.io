...
One can say that India, in itself, is a homeschooling country because more than 50% of the time, children study in home tuition classes. They are still in school because it provides the curriculum, systemization, and guidance on what to study and what not to study. Schools put children in a feedback loop of study, with homework assigned every day to be completed in tuition, and they also conduct exams. Although the practices of schools are questionable and not optimal, without them, it can be chaos. Homeschooling during COVID times was a dystopian chaos. Parents and tuition teachers are not experts in the curriculum; they need a centralized board or governance for recommendations. What we need is a redesign of the curriculum framework and governance to keep students in the feedback loop.
