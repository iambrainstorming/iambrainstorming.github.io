...
Every search, click, or location ping generates **user data**, which Google collects globally.
That data fuels:
...
But users — who *create* that data — get **no compensation**.
In economic terms, it’s an **unpaid resource extraction**, similar to taking minerals or oil without paying for them.
...
Ports are natural monopolies — only one can operate efficiently in a region.
When Adani controls multiple coastal points:
...
This is known as **“regulatory capture”** — when private interests shape government rules in their favor.
Over time, public interest takes a back seat to corporate interest.
