...
In India, where E85 has recently been launched, the fuel is priced at ₹82.12 per litre in Delhi, which is approximately ₹20 cheaper than standard E20 petrol. Because ethanol has lower energy density than petrol, vehicles experience a 20–35% drop in fuel efficiency when using E85. Consequently, the lower pump price may not translate to lower per-kilometre running costs. So it’s hardly any cheaper than patrol.
